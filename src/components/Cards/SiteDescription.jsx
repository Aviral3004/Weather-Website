...
const SiteDescription = () => {
  return (
    <motion.p className="font-spacegrotesk text-justify text-sm md:text-lg">
      ...
      The <span className="text-black-400 font-bold">one day forecast</span>{" "}
      provides a detailed overview of the weather conditions for the upcoming 24
      hours, while the{" "}
      <span className="text-black-400 font-bold">five day forecast</span> gives
      ...
      the{" "}
      <span className="text-black-400 font-bold">forecasts for 50 cities</span>{" "}
